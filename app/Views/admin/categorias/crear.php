        ...
        <div class="col-md-8">
            <div class="card mb-4 mx-4">
                <div class="card-body p-4">
                    ...
                    <p class="text-body-secondary">Create category</p>
                    <form action="<?= site_url('admin/categorias/guardar') ?>" method="POST" class="needs-validation" novalidate>
                        <?= csrf_field() ?>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="input-group mb-3"><span class="input-group-text">
                                    ...
                                    <textarea class="form-control <?= isset($errors['descripcion']) ? 'is-invalid' : '' ?>" name="descripcion" type="text" placeholder="Descripción" value="<?= old('descripcion') ?>" minlength="5" maxlength="500" required></textarea>
