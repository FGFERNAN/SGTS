...
<?= $this->section('titulo') ?>Dashboard Tecnico - SGTS<?= $this->endSection() ?>

<?= $this->section('sidebar') ?>
<?= $this->include('layouts/partials/tecnico/sidebar') ?>
<?= $this->endSection() ?>

<?= $this->section('navbar') ?>
<?= $this->include('layouts/partials/tecnico/navbar') ?>
<?= $this->endSection() ?>

<?= $this->section('contenido') ?>
<h1 class="mb-4">Dashboard Tecnico</h1>
<div class="card">
    <div class="card-body">
            ...
            <div class="modal fade" id="modalDetallesTicket" tabindex="-1" aria-labelledby="modalDetallesTicketLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="<?= site_url('tecnico/tickets/registrar-avances') ?>" method="POST" class="needs-validation" novalidate>
                            <?= csrf_field() ?>
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <label for="modal-observacion" class="col-form-label">Observación:</label>
                                            <textarea class="form-control" name="mensaje" id="modal-observacion"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-12">
            ...
            <div class="modal fade" id="modalComentarios" tabindex="-1" aria-labelledby="modalComentarios" aria-hidden="true">
                <div class="modal-dialog modal-dialog-scrollable">
                    <div class="modal-content">
                        ...
                        <form action="<?= site_url('tecnico/tickets/comentar') ?>" method="POST" class="needs-validation" novalidate>
                            <?= csrf_field() ?>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // 1. Selecciona el modal y list group
        ...
        const modalObservacion = modalDetalles.querySelector('#modal-observacion');
        ...
        modalObservacion.addEventListener('input', function() {
            // Compara el valor actual con el valor 'inicial' que guardamos en el data-attribute
            if (this.value !== this.dataset.initialValue) {
                btnGuardarCambios.removeAttribute('disabled');
            } else {
        ...
        modalDetalles.addEventListener('show.coreui.modal', function(event) {
            ...
            fetch(`${baseUrl}tecnico/tickets/obtener-observaciones/${idTicket}`)
        ...
        modalComentarios.addEventListener('show.coreui.modal', function() {
            ...
            fetch(`${baseUrl}tecnico/tickets/obtener-comentarios/${idTicket}`)
                .then(response => response.json())
                .then(data => {
